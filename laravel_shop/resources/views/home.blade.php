        ...
        <div class="max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-16">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <a href="{{ route('offers') }}" class="text-sm font-bold text-gray-500 hover:text-neon-red transition uppercase tracking-widest">Ver todas</a>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            ...
            <div class="mb-16">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <a href="{{ route('products.index') }}" class="text-sm font-bold text-gray-500 hover:text-neon-purple transition uppercase tracking-widest">Ver todo</a>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                    @php
                        $exclusiveProducts = App\Models\Product::where('is_exclusive', true)
                            ...
                            ->get();
                    @endphp
                    @forelse($exclusiveProducts as $product)
                        @include('products.partials.product-card', ['product' => $product])
                    @empty
