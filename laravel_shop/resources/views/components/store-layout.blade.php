            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li><a href="{{ route('products.category', 'consolas') }}" class="hover:text-white transition">Consolas</a></li>
                        <li><a href="{{ route('products.category', 'videojuegos') }}" class="hover:text-white transition">Videojuegos</a></li>
                        <li><a href="{{ route('products.category', 'manga') }}" class="hover:text-white transition">Manga</a></li>
                        <li><a href="{{ route('products.category', 'productos-anime') }}" class="hover:text-white transition">Productos Anime</a></li>
                        <li><a href="{{ route('products.category', 'cosplay') }}" class="hover:text-white transition">Cosplay</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        ...
                        <li><a href="{{ route('products.index') }}" class="hover:text-white transition">Todos los productos</a></li>
                        <li><a href="{{ route('offers') }}" class="hover:text-white transition">Ofertas</a></li>
