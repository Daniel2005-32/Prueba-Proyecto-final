            ...
            <div class="bg-gamer-card rounded-2xl border border-neon-purple/30 p-8 text-center">
                ...
                <div class="bg-gray-800/50 rounded-lg p-4 mb-8">
                    ...
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-white line-through"><?php echo e(number_format($originalPrice, 2)); ?>€</span>
                    </div>
                    <div class="flex justify-between items-center text-lg font-bold">
                        <span class="text-gray-300">Precio de salida:</span>
                        <span class="text-neon-purple"><?php echo e(number_format($startingPrice, 2)); ?>€</span>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <form action="<?php echo e(route('auctions.cancel', $product->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit" 
