<div class="mt-8" x-data="reviews()" x-init="init(<?php echo e($product->id); ?>)">
    ...
    <?php else: ?>
        <div class="bg-gamer-card rounded-2xl border border-neon-purple/20 p-6 mb-6 text-center">
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-neon-purple hover:underline">Inicia sesión</a>
        </div>
    <?php endif; ?>
...
function reviews() {
    return {
        ...
        hasUserReviewed: <?php echo e(auth()->check() ? ($product->reviewedByUser(auth()->id()) ? 'true' : 'false') : 'false'); ?>,
        userRating: 0,
        userComment: '',
...
<?php /**PATH /home/ctk/Documentos/Proyecto_Daniel/Proyecto-final-main/laravel_shop/resources/views/products/partials/reviews.blade.php ENDPATH**/ ?>