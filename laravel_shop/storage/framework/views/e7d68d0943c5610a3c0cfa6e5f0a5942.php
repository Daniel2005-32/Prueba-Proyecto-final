...
function floatingChat() {
    return {
        ...
        messages: [],
        newMessage: '',
        currentUserId: <?php echo e(auth()->id() ?? 'null'); ?>,
        ...
        loadMessages() {
            fetch('<?php echo e(route("chat.refresh")); ?>')
...
</script><?php /**PATH /home/ctk/Documentos/Proyecto_Daniel/Proyecto-final-main/laravel_shop/resources/views/components/floating-chat.blade.php ENDPATH**/ ?>