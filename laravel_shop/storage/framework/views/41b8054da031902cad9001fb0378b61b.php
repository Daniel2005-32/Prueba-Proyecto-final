                            ...
                            <div class="text-center py-8">
                                <?php if($product->auction_winner_id == Auth::id()): ?>
                                    <div class="bg-green-900/30 border border-green-500 rounded-lg p-6">
                                        ...
                                        <p class="text-neon-purple text-2xl font-bold"><?php echo e(number_format($product->auction_final_price ?? $product->price, 2)); ?>€</p>
                                    </div>
                                <?php elseif($product->auction_winner_id): ?>
                                    <div class="bg-gray-800/50 rounded-lg p-6">
                                        ...
                                        <p class="text-neon-purple mt-2"><?php echo e(number_format($product->auction_final_price ?? $product->price, 2)); ?>€</p>
                                    </div>
                                <?php else: ?>
                                    <div class="bg-gray-800/50 rounded-lg p-6">
