                            ...
                            <table class="w-full">
                                ...
                                <tbody id="cart-items">
                                    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr class="border-b border-gray-800 hover:bg-gray-800/50 transition" data-id="<?php echo e($id); ?>" data-price="<?php echo e($item['price']); ?>">
                                            <td class="px-6 py-4">
                                            ...
                                            <td class="px-6 py-4 text-gray-300 price-cell"><?php echo e(number_format($item['price'], 2)); ?>€</td>
                                            <td class="px-6 py-4">
                                                <div class="flex items-center space-x-2">
                                                    <button type="button" 
                                                            onclick="updateQuantityFromInput(<?php echo e($id); ?>, 'decrease')" 
                                                    ...
                                                    <input type="number" 
                                                           ...
                                                           onchange="updateQuantity(<?php echo e($id); ?>, this.value)">
                                                    
                                                    <button type="button" 
                                                            onclick="updateQuantityFromInput(<?php echo e($id); ?>, 'increase')" 
                                                            class="w-8 h-8 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-neon-blue/20 transition disabled:opacity-50 disabled:cursor-not-allowed"
                                                            <?php echo e($item['quantity'] >= $maxStock ? 'disabled' : ''); ?>>
                                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <td class="px-6 py-4 text-white font-bold item-total"><?php echo e(number_format($itemTotal, 2)); ?>€</td>
                                            <td class="px-6 py-4">
                                                <form action="<?php echo e(route('cart.remove', $id)); ?>" method="POST" class="inline">
                                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-gamer-card rounded-2xl border border-neon-purple/20 p-6 sticky top-24">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex justify-between text-xl font-bold text-white">
                                    <span>Total:</span>
                                    <span id="cart-total"><?php echo e(number_format($subtotal, 2)); ?>€</span>
                                </div>
...
<?php endif; ?><?php /**PATH /home/ctk/Documentos/Proyecto_Daniel/Proyecto-final-main/laravel_shop/resources/views/cart/index.blade.php ENDPATH**/ ?>