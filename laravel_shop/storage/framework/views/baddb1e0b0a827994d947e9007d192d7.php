                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                        ...
                                        <tr class="border-b border-gray-800 hover:bg-gray-800/50 transition">
                                            ...
                                            <td class="px-6 py-4">
                                                <form action="<?php echo e(route('cart.update', $id)); ?>" method="POST" class="flex items-center space-x-2">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="number" name="quantity" value="<?php echo e($item['quantity']); ?>" min="1" max="10" 
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-gamer-card rounded-2xl border border-neon-purple/20 p-6 sticky top-24">
                            ...
                            <!-- BOTÓN DE CANCELAR ORDEN (vaciar carrito) -->
                            <div class="mt-6 space-y-3">
                                <form action="<?php echo e(route('cart.clear')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="w-full px-6 py-3 bg-gray-800 text-gray-300 font-bold rounded-lg hover:bg-gray-700 transition border border-gray-700">
                                        🗑️ Cancelar pedido (vaciar carrito)
                                    </button>
                                </form>

                                <!-- CHECK DE AUTENTICACIÓN PARA COMPRAR -->
                                ...
                                <?php else: ?>
                                    <div class="bg-gray-800/50 border border-neon-red/30 rounded-lg p-4 text-center">
