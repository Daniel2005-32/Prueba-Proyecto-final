                        ...
                        <?php $__currentLoopData = $raffles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $raffle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="border-b border-gray-800 hover:bg-gray-800/50 transition">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-gray-500 text-xs"><?php echo e($cleanDesc); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                    <?php if($product): ?>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <?php else: ?>
                                        <span class="px-3 py-1 bg-gray-600/20 text-gray-400 rounded-full text-xs"><?php echo e($raffle->status); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-2">
                                        ...
                                        <?php if($raffle->status == 'pending' || $raffle->status == 'completed'): ?>
